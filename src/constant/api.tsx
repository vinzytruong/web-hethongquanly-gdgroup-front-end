export const apiPort = 'http://192.168.50.222:8899'
...
//Nha thau
export const getNhaThau = apiPort + "/api/NhaThau/GetNhaThau"
...
//Co quan
export const getCoQuan = apiPort + "/api/NSCoQuan/GetCoQuan"
