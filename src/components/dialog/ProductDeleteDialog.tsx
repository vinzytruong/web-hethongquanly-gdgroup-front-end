...
export default function ProductDeleteDialog(props: PropsDialog) {
    ...
    const { removeProduct, dataProduct } = useProduct()
            ...
            >
                ...
                <DialogContent sx={{ padding: 3 }}>
                    <DialogContentText id="alert-dialog-description">
                        <Typography variant='body1'>Khi đã xoá sẽ không thể khôi phục. Bạn có chắc muốn xoá sản phẩm này hay không? </Typography>
                    </DialogContentText>
                </DialogContent>
