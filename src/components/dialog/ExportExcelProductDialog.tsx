...
export const validationUtilizedObjectSchema = yup.object({
    ...
    circularId: yup
        .number()
        .positive("Vui lòng chọn thông tư")
        .required("Vui lòng chọn thông tư")
        .min(1, "Vui lòng chọn thông tư"),
...
export default function ExportExcelProductDialog(props: Props) {
                                            ...
                                            <Box style={{ width: "100%" }} sx={{ mb: 1.5 }}>
                                                ...
                                                <FormControl fullWidth>
                                                    <Select
                                                        ...
                                                        name="circularId"
                                                        type="circularId"
                                                        value={formik.values.circularId}
                                                        onChange={formik.handleChange}
                                                        onBlur={formik.handleBlur}
                                                        error={
                                                            formik.touched.circularId &&
                                                            Boolean(formik.errors.circularId)
                                                        }
                                                    >
                                                ...
                                                {formik.touched.circularId &&
                                                    Boolean(formik.errors.circularId) && (
                                                        <FormHelperText className="required_text">
                                                            {" "}
                                                            {formik.errors.circularId
                                                                ? formik.errors.circularId.toString()
                                                                : ""}
                                                        </FormHelperText>
                                                    )}
                                            </Box>
