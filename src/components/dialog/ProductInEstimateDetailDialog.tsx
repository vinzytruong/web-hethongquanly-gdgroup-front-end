...
export default function ProductInEstimateDetailDialog(props: PropsDialog) {
    ...
    const formik = useFormik({
        initialValues: {
            ...
            hangSanXuat: defaulValue?.hangSanXuat ?? null,
            thuongHieu: defaulValue?.hangSanXuat ?? null,
            model: defaulValue?.hangSanXuat ?? null,
            xuatXu: defaulValue?.hangSanXuat ?? null,
            nhaXuatBan: defaulValue?.hangSanXuat ?? null,
            ...
            giaDaiLy: defaulValue?.giaDaiLy ?? "",
            giaTTR: defaulValue?.giaTTR ?? "",
            giaCDT: defaulValue?.giaCDT ?? "",
            giaVon: defaulValue?.giaVon ?? "",
            giaTH_TT: defaulValue?.giaTH_TT ?? "",
        },
        ...
        onSubmit: async (values) => {
            ...
            const data: Products = {
                ...
                giaDaiLy: parseInt(values.giaDaiLy.toString()),
                giaCDT: parseInt(values.giaCDT.toString()),
                giaVon: parseInt(values.giaCDT.toString()),
                giaTH_TT: parseInt(values.giaTH_TT.toString()),
                giaTTR: parseInt(values.giaTTR.toString()),
            ...
            try {
                if (isInsert) {
                    ...
                    data.sanPhamID = defaulValue.sanPhamID;
                                ...
                                <Grid item xs={5}>
                                    <Grid container spacing={3} sx={{ mb: 1.5 }}>
                                        <Grid item md={6}>
                                            <Box style={{ width: "100%" }}>
                                                <Typography sx={{ mb: 1.5, fontWeight: "bold" }}>
                                                    Giá TTR <span className="required_text">(*)</span>
                                                </Typography>
                                                <TextField
                                                    style={{ width: "100%" }}
                                                    name="giaTTR"
                                                    value={giaTTR}
                                                    error={
                                                        formik.touched.giaTTR &&
                                                        Boolean(formik.errors.giaTTR)
                                                    }
                                                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                                                        handleChangePrice(e, setGiaTTR)
                                                    }
                                                    InputProps={{
                                                        endAdornment: (
                                                ...
                                                {formik.touched.giaTTR &&
                                                    Boolean(formik.errors.giaTTR) && (
                                                        <FormHelperText className="required_text">
                                                            {" "}
                                                            {formik.errors.giaTTR
                                                                ? formik.errors.giaTTR.toString()
                                                                : ""}
                                                        </FormHelperText>
                                                    )}
                                            </Box>
                                        ...
                                        <Grid item md={6}>
                                            <Box style={{ width: "100%" }}>
                                                <Typography sx={{ mb: 1.5, fontWeight: "bold" }}>
                                                    Giá TH-TT <span className="required_text">(*)</span>
                                                </Typography>
                                                <TextField
                                                    style={{ width: "100%" }}
                                                    name="giaTH_TT"
                                                    value={giaTH_TT}
                                                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                                                        handleChangePrice(e, setGiaTH_TT)
                                                    }
                                                    error={
                                                        formik.touched.giaTH_TT &&
                                                        Boolean(formik.errors.giaTH_TT)
                                                    }
                                                    InputProps={{
                                                        endAdornment: (
                                                            <InputAdornment position="end">
                                                ...
                                                {formik.touched.giaTH_TT &&
                                                    Boolean(formik.errors.giaTH_TT) && (
                                                        <FormHelperText className="required_text">
                                                            {" "}
                                                            {formik.errors.giaTH_TT
                                                                ? formik.errors.giaTH_TT.toString()
                                                                : ""}
                                                        </FormHelperText>
                                                    )}
                                            </Box>
                                    ...
                                    <Grid container spacing={3} sx={{ mb: 1.5 }}>
                                        <Grid item md={6}>
                                            <Box style={{ width: "100%" }}>
                                                <Typography sx={{ mb: 1.5, fontWeight: "bold" }}>
                                                    Giá CĐT <span className="required_text">(*)</span>
                                                </Typography>
                                                <TextField
                                                    style={{ width: "100%" }}
                                                    name="giaCDT"
                                                    value={giaCDT}
                                                    error={
                                                        formik.touched.giaCDT &&
                                                        Boolean(formik.errors.giaCDT)
                                                    }
                                                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                                                        handleChangePrice(e, setGiaCDT)
                                                    }
                                                    InputProps={{
                                                        endAdornment: (
                                                            <InputAdornment position="end">
                                                ...
                                                {formik.touched.giaCDT &&
                                                    Boolean(formik.errors.giaCDT) && (
                                                        <FormHelperText className="required_text">
                                                            {" "}
                                                            {formik.errors.giaCDT
                                                                ? formik.errors.giaCDT.toString()
                                                                : ""}
                                                        </FormHelperText>
                                                    )}
                                            </Box>
                                        ...
                                        <Grid item md={6}>
                                            <Box style={{ width: "100%" }}>
                                                <Typography sx={{ mb: 1.5, fontWeight: "bold" }}>
                                                    Giá đại lý <span className="required_text">(*)</span>
                                                </Typography>
                                                <TextField
                                                    style={{ width: "100%" }}
                                                    name="giaDaiLy"
                                                    value={giaDaiLy}
                                                    error={
                                                        formik.touched.giaDaiLy &&
                                                        Boolean(formik.errors.giaDaiLy)
                                                    }
                                                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                                                        handleChangePrice(e, setGiaDaiLy)
                                                    }
                                                    InputProps={{
                                                        endAdornment: (
                                                            <InputAdornment position="end">
                                                ...
                                                {formik.touched.giaDaiLy &&
                                                    Boolean(formik.errors.giaDaiLy) && (
                                                        <FormHelperText className="required_text">
                                                            {" "}
                                                            {formik.errors.giaDaiLy
                                                                ? formik.errors.giaDaiLy.toString()
                                                                : ""}
                                                        </FormHelperText>
                                                    )}
                                            </Box>
