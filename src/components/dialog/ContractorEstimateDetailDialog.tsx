...
export const validationUtilizedObjectSchema = yup.object({
    canBoTiepXuc: yup.string().required("Vui lòng nhập tên các bộ tiếp xúc"),
    soDienThoai: yup.string().required("Vui lòng nhập tên các bộ tiếp xúc"),
...
export default function ContractorEstimateDetailDialog(props: Props) {
                        ...
                        >
                            <Grid item md={11}>
                                ...
                                <Grid container>
                                    ...
                                    <Grid item md={6}>
                                        {defaulValue.loaiSanPham && defaulValue.loaiSanPham.length > 0
