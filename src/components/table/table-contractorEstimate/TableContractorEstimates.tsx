...
import TableBodyContractorEstimates from './TableBody';
...
const headCells: readonly HeadCell[] = [
    {
        id: 'contractorestimate_tinh',
        numeric: false,
        disablePadding: false,
        label: 'Nhà thầu',
    },
    {
        id: 'contractorestimate_tenDuToan',
        numeric: false,
        disablePadding: false,
    ...
    {
        id: 'contractorestimate_trangThai',
        numeric: false,
        disablePadding: false,
        label: 'Loại báo giá',
    },
    {
        id: 'contractorestimate_ketQua',
        numeric: false,
        disablePadding: false,
        label: 'Kết quả',
    },
    {
        id: 'contractorestimate_doanhThuDuKien',
        numeric: false,
        disablePadding: false,
        label: 'Doanh thu dự kiến',
    },
    // {
    //     id: 'contractorestimate_fileNhaThau',
    //     numeric: false,
    //     disablePadding: false,
    //     label: 'File nhà thầu',
    // },
    // {
    //     id: 'contractorestimate_fileCongTy',
    //     numeric: false,
    //     disablePadding: false,
    //     label: 'File công ty',
    // },
    {
        id: 'contractorestimate_ngayTao',
        numeric: false,
        disablePadding: false,
        label: 'Ngày tạo',
    },
    {
        id: 'contractorestimate_ngayCapNhat',
        numeric: false,
        disablePadding: false,
        label: 'Ngày cập nhật',
    },
];
const TableContractorEstimates = ({ rows, isAdmin, dataContractorTags, dataSourceOfFunds, fetchContractorEstimatesList }: Props) => {
    const [order, setOrder] = React.useState<Order>('asc');
    const [orderBy, setOrderBy] = React.useState<keyof ContractorEstimate>('tenDuToan');
...
export default TableContractorEstimates
