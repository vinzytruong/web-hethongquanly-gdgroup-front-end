...
//     const { deleteMulContractors } = useContractors()
//     const handleDelete = (ids: number[]) => {
//         deleteMulContractors(ids)
//         handleSelected([])
//     }
//     return (
//         <Toolbar
...
// };
// export default function ContractorsTable(props: PropsTable) {
//     const { title, handleOpenCard, handleViewId, rows } = props
//     const [order, setOrder] = React.useState<Order>('asc');
//     const [orderBy, setOrderBy] = React.useState<keyof Contractors>('nhaThauID');
...
//             const newSelected = rows.map((n) => n.nhaThauID);
...
//                                     const isItemSelected = isSelected(Number(row.nhaThauID));
...
//                                                 <Checkbox
//                                                     color="primary"
//                                                     onClick={(event) => handleClick(event, Number(row.nhaThauID))}
...
//                                                     <IconButton onClick={(e: any) => handleViewItem(e, row.nhaThauID)}>
