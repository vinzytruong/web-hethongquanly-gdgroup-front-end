...
import TableBodyProductTypes from './TableBody';
...
const TableProductTypes = ({ rows, isAdmin }: Props) => {
    const [order, setOrder] = React.useState<Order>('asc');
    const [orderBy, setOrderBy] = React.useState<keyof ProductTypes>('tenLoaiSanPham');
