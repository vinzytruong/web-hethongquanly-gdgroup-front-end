...
import TableBodyApproveLeave from './TableBodyApproveLeave';
...
const TableOnLeave = ({ rows, isAdmin, setViewId, setDeleteId, handleUpdateStatus, setEditId }: ProductProps) => {
