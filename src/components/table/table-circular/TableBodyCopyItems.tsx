...
const TableBodyCopyItems = (props: BodyDataProps) => {
    ...
    return (
        <TableBody>
            ...
            {
                open === true && selectedID && <ProductsDialog title="Cập nhật sản phẩm" defaulValue={data.find(item => item.sanPhamID === selectedID)} handleOpen={setOpen} open={open} isUpdate />
            }
            {
                openViewItem === true && selectedID && <ProductViewDetailDialog title="Thông tin chi tiết" defaulValue={data.find(item => item.sanPhamID === selectedID)} handleOpen={setOpenViewItem} open={openViewItem} isUpdate />
            }
            {
...
export default TableBodyCopyItems;
