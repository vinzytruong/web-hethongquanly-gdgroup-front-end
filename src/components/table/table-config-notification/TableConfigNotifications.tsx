...
import TableBodyConfigNotifications from './TableBody';
...
const TableConfigNotifications = ({ rows, isAdmin,fetchData }: Props) => {
    const [order, setOrder] = React.useState<Order>('asc');
    const [orderBy, setOrderBy] = React.useState<keyof ConfigNotification>('maThongBao');
...
export default TableConfigNotifications
