...
import TableBodyCompanyEstimates from './TableBody';
...
const TableCompanyEstimates = ({ rows, isAdmin }: Props) => {
    const [order, setOrder] = React.useState<Order>('asc');
    const [orderBy, setOrderBy] = React.useState<keyof CompanyEstimates>('tenCongTy');
...
export default TableCompanyEstimates
