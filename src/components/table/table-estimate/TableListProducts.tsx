...
const headCellListProductInEstimates: readonly HeadCell[] = [
...
const TableListProducts = ({ rows, isAdmin, isListProductsInEstimates, checked, onHandleChecked }: Props) => {
                    ...
                    <TableContainer sx={{ border: 0, borderRadius: '6px', minWidth: 650 }}>
                        ...
                        >
                            <TableHeader
                                ...
                                headerCells={isListProductsInEstimates ? headCellListProductInEstimates : headCells}
                                action={false}
                            />
                            <TableBodyProducts
                                data={visibleRows}
