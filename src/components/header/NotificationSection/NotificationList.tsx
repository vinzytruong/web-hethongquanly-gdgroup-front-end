...
const NotificationList = () => {
    ...
    const chipSuccessSX = {
        ...
        backgroundColor: theme.palette.mode === 'dark' ? theme.palette.primary.main : theme.palette.success.light,
        height: 28
    };
        ...
        >
            <ListItemWrapper>
                <ListItem alignItems="center">
                    <ListItemAvatar>
                        <Avatar alt="John Doe" src='https://png2.cleanpng.com/sh/dd4ebdfbe6e11c4033f5606eac07394b/L0KzQYm3U8A1N6Z5j5H0aYP2gLBuTgRmdaFxeeZuLXT1ccjwjvcudZJzRdNBYYTkgn68gcljbJM6TqM9OEC8RXACU8QyPWkASqMAMkC0RoS9V8AxQGUziNDw/kisspng-template-drawing-man-avatar-5a9bdb56148095.934158921520163670084.png' />
                    </ListItemAvatar>
